...
using TelerikBlazorSampleApp.Models;
...
namespace TelerikBlazorSampleApp.Pages
{
    public partial class Products
    {
        ...
        TelerikChart BubbleRef { get; set; }
        ...
        private void Filter()
        {
            ...
            productsData = (List<ProductDto>)(products.ToDataSourceResult(request).Data as IEnumerable<ProductDto>);
        }
